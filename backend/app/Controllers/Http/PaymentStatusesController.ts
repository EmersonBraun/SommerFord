...
import PaymentStatusesRepository from 'App/Repositories/PaymentStatusesRepository'
import { PaymentStatusSchema } from 'App/Validators/PaymentStatusSchema'

export default class PaymentStatusesController {
  private readonly repository
  constructor () {
    this.repository = PaymentStatusesRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: PaymentStatusSchema})
    } catch (error) {
